...
%возвращает структуру нейронной сети с n =numel(architecture), причем архитектура
%представляет собой вектор размером n x 1, например, размеры слоев. [784 100 10]
